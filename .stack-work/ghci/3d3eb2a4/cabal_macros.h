...
/* package text-tracker-0.1.0.0 */
#ifndef VERSION_text_tracker
#define VERSION_text_tracker "0.1.0.0"
#endif /* VERSION_text_tracker */
#ifndef MIN_VERSION_text_tracker
#define MIN_VERSION_text_tracker(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_text_tracker */
...
#define CURRENT_COMPONENT_ID "text-tracker-0.1.0.0-4iaI7YJTzxpL7w4YrkZSS0-text-tracker"
